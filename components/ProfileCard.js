...
const WhatsAppIcon = (props) => (
  ...
  >
    <path d="M12 2a10 10 0 0 0-8.66 15L2 22l5.13-1.35A10 10 0 1 0 12 2zm0 18a8 8 0 0 1-4.14-1.15l-.3-.17-3.08.81.82-3-1.85-.3A8 8 0 1 1 12 20z" />
    <path d="M15.42 12.87c-.24-.12-1.42-.7-1.65-.78-.22-.08-.39-.12-.55.12-.17.25-.66.83-.81 1-.15.17-.3.19-.54.07a6.76 6.76 0 0 1-2-.13 7.82 7.82 0 0 1-1.38-.9c-.2-.17-.03-.26.1-.39.12-.12.24-.29.36-.43.12-.14.16-.24.24-.4.08-.17.04-.32-.02-.44s-.55-1.3-.75-1.79c-.2-.48-.41-.41-.56-.42h-.47a1 1 0 0 0-.7.31 2.92 2.92 0 0 0-.91 2.16c0 1 .42 1.93.48 2 .06.08 1.4 2.14 3.39 3 .47.2.84.32 1.13.41.5.16.95.14 1.31.08a1.64 1.64 0 0 0 1.09-.77c.21-.59.21-1.09.15-1.2s-.22-.17-.46-.29z" />
  </svg>
);
